...
<!-- 
   agregar en Periodos/form.blade
   el formulario va desde el primer campo hasta el boton de Guardar 
   
    Ejemplo de foto, al parecer en la base de datos es de string()
...
## heroku CLI
> heroku apps
> heroku git:remote -a laravel-heroku-pg
